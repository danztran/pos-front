<template>
	<div class="centered-container">
		...
		<md-card>
			<md-progress-bar v-visible="loading" md-mode="indeterminate" />
			<md-content>
				<form @submit.prevent="sendAuth">
					...
					<md-card-actions>
						<div class="actions md-layout md-alignment-center-space-between">
							<span v-on-clickaway="clearMsg" class="md-accent" style="color: red;">
								{{ message }}
							</span>
