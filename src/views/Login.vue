<template>
  <div class="centered-container">
    <md-content class="md-elevation-3">
      ...
      <div class="title">
        <img src="https://image.flaticon.com/icons/png/512/64/64526.png" />
        <div class="md-title">Login to POS</div>
        ...
        <div class="form">
          ...
          <md-field md-has-password :class="password.status">
            ...
            <md-input
              ...
              type="password"
              @keyup.enter="sendAuth"
              @focus="password.status = ''"
